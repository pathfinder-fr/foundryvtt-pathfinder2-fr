...
SUPPORTED = {
  "spells":                         { 'transl': "Sorts", 'name': "name", 'desc': "data.description.value", 'type1': "data.school.value", 'type2': "data.level.value" },
  "feats":                          { 'transl': "Dons",  'name': "name", 'desc': "data.description.value", 'type1': "data.featType.value", 'type2': "data.level.value" },
  "equipment":                      { 'transl': "Équipement", 'name': "name", 'desc': "data.description.value", 'type1': "type", 'type2': "data.level.value" },
  "conditions":                     { 'transl': "Conditions", 'name': "name", 'desc': "content" },
  "actions":                        { 'transl': "Actions", 'name': "name", 'desc': "data.description.value" },
  "archetypes":                     { 'transl': "Archétypes", 'name': "name", 'desc': "content" },
  #"pathfinder-bestiary":            { 'transl': "Bestiaire", 'name': "name", 'desc': "content" },
  #"pathfinder-bestiary-2":          { 'transl': "Bestiaire 2", 'name': "name", 'desc': "content" },
  #"hazards":                        { 'transl': "Dangers", 'name': "name", 'desc': "content" },
  #"age-of-ashes-bestiary":          { 'transl': "Dangers", 'name': "name", 'desc': "content" },
  #"extinction-curse-bestiary":      { 'transl': "Dangers", 'name': "name", 'desc': "content" },
  #"fall-of-plaguestone-bestiary":   { 'transl': "Dangers", 'name': "name", 'desc': "content" },
  #"iconics":                        { 'transl': "Dangers", 'name': "name", 'desc': "content" },
  #"npc-gallery":                    { 'transl': "Dangers", 'name': "name", 'desc': "content" },
  "ancestryfeatures":               { 'transl': "Ascendances", 'name': "name", 'desc': "data.description.value", 'type1': "type", 'type2': "data.level.value" },
  "classfeatures":                  { 'transl': "Capacités de classe", 'name': "name", 'desc': "data.description.value", 'type1': "data.traits.value", 'type2': "data.level.value" },
  #"rollable-tables":                { 'transl': "Dangers", 'name': "name", 'desc': "content" },
  "backgrounds":                    { 'transl': "Backgrounds", 'name': "name", 'desc': "content" },
  #"deities":                        { 'transl': "Divinités", 'name': "name", 'desc': "content" },
  #"gmg-srd":                        { 'transl': "Guide du MJ", 'name': "name", 'desc': "content" },
  "classes":                        { 'transl': "Classes", 'name': "name", 'desc': "content" },
  #"criticaldeck":                   { 'transl': "Critiques", 'name': "name", 'desc': "content" },
  #"pf2e-macros":                    { 'transl': "Macros PF2e", 'name': "name", 'desc': "content" },
  "bestiary-ability-glossary-srd":  { 'transl': "Sorts", 'name': "name", 'desc': "data.description.value" },
  #"pathfinder-society-boons":       { 'transl': "Macros PF2e", 'name': "name", 'desc': "content" },
  "boons-and-curses":               { 'transl': "Sorts", 'name': "name", 'desc': "data.description.value" },
}
