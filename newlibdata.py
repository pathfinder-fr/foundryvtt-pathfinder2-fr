...
# lists     Dictionnaire contenant la liste des champs supplémentaires à extraire sous forme de liste, dont les différentes valeurs seront extraites avec un "|" comme séparateur, et à traduire.
    ##### Tous les bestiaires des différentes aventures et campagnes qui ne seront pas traduits
    # "abomination-vaults-bestiary":        { 'transl': "Dangers", "paths": { 'name': "name", 'desc': "content" } },
    # "age-of-ashes-bestiary":              { 'transl': "Dangers", "paths": { 'name': "name", 'desc': "content" } },
    # "agents-of-edgewatch-bestiary":       { 'transl': "Dangers", "paths": { 'name': "name", 'desc': "content" } },
    # "blog-bestiary":                      { 'transl': "Dangers", "paths": { 'name': "name", 'desc': "content" } },
    # "april-fools-bestiary":               { 'transl': "Dangers", "paths": { 'name': "name", 'desc': "content" } },
    ...
    # "fists-of-the-ruby-phoenix-bestiary": { 'transl': "Dangers", "paths": { 'name': "name", 'desc': "content" } },
    # "iconics":                            { 'transl': "Dangers", "paths": { 'name': "name", 'desc': "content" } },
    # "malevolence-bestiary":               { 'transl': "Dangers", "paths": { 'name': "name", 'desc': "content" } },
    # "menace-under-otari-bestiary":        { 'transl': "Dangers", "paths": { 'name': "name", 'desc': "content" } },
    # "monsters-of-the-myth-bestiary":      { 'transl': "Dangers", "paths": { 'name': "name", 'desc': "content" } },
    # "mwangi-expanse-bestiary" :           { 'transl': "Dangers", "paths": { 'name': "name", 'desc': "content" } },
    # "night-of-the-gray-death-bestiary":   { 'transl': "Dangers", "paths": { 'name': "name", 'desc': "content" } },
    # "npc-gallery":                        { 'transl': "Dangers", "paths": { 'name': "name", 'desc': "content" } },
    # "one-shot-bestiary":                  { 'transl': "Dangers", "paths": { 'name': "name", 'desc': "content" } },
    # "pfs-introductions-bestiary":         { 'transl': "Dangers", "paths": { 'name': "name", 'desc': "content" } },
    # "pfs-season-1-bestiary":              { 'transl': "Dangers", "paths": { 'name': "name", 'desc': "content" } },
    # "pfs-season-2-bestiary":              { 'transl': "Dangers", "paths": { 'name': "name", 'desc': "content" } },
    # "pfs-season-3-bestiary":              { 'transl': "Dangers", "paths": { 'name': "name", 'desc': "content" } },
    # "quest-for-the-frozen-flame-bestiary":{ 'transl': "Dangers", "paths": { 'name': "name", 'desc': "content" } },
    # "strength-of-thousands-bestiary":     { 'transl': "Dangers", "paths": { 'name': "name", 'desc': "content" } },
    # "the-slithering-bestiary":            { 'transl': "Dangers", "paths": { 'name': "name", 'desc': "content" } },
    # "troubles-in-otari-bestiary":         { 'transl': "Dangers", "paths": { 'name': "name", 'desc': "content" } },
    #### Les effets des campagnes ne sont pas prioritaires
    # "campaign-effects":                   { 'transl': "Dangers", "paths": { 'name': "name", 'desc': "content" } },
    #### Les compendium qui nécessitent trop de travail pour un intérêt limité
    # "rollable-tables":                { 'transl': "Dangers", "paths": { 'name': "name", 'desc': "content" } },
    # "hero-point-deck":                { 'transl': "Critiques", "paths": { 'name': "name", 'desc': "content" } },
SUPPORTED = {
